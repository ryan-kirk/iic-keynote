...
export interface ThresholdAnnotationStory {
  thresholds: ThresholdRule[];
  comparisonWindows: ComparisonWindow[];
  annotations: StoryAnnotation[];
}

export interface ThresholdAnnotationManifest {
  schemaVersion: string;
  stories: Record<StoryId, ThresholdAnnotationStory>;
}
    ...
    panels: [
      {
        ...
        description:
          'Proxy market and financing series, rebased to January = 100, show the real economic setup before any synthetic response is introduced.',
      ...
      },
      {
        ...
        description:
          'Synthetic pressure example shows how a co-op could combine the real proxy inputs into a watch-and-escalate workflow.',
        minValue: 88,
        maxValue: 118,
      ...
      },
      {
        ...
        description:
          'Synthetic booking response shows how member behavior could soften after the pressure story moves into watch territory.',
        minValue: 86,
        maxValue: 110,
    ...
    panels: [
      {
        ...
        description:
          'Real Mesonet temperature anomalies show the hot weeks that plausibly push the canopy into stress during late vegetative growth.',
        minValue: -5,
        maxValue: 12,
      ...
      },
      {
        ...
        eyebrow: 'Real weather context',
        description:
          'Real Mesonet precipitation anomalies show the dry windows and the rain week that supports the first NDVI recovery.',
        minValue: -1.5,
        maxValue: 4.5,
      ...
      },
      {
        ...
        description:
          'Synthetic NDVI anomaly line shows a late-June drop, a rain-assisted early-July recovery, and a second stress wave near pollination and early grain fill.',
        minValue: -0.1,
        maxValue: 0.06,
    ...
    panels: [
      {
        ...
        description:
          'Real USDA report values lead the story and establish the statewide harvest curve before any synthetic operational inference is shown.',
        minValue: 0,
        maxValue: 100,
        series: [
      ...
      },
      {
        ...
        description:
          'Synthetic intake curve is inferred from the USDA harvest ramp and shows how inbound pressure could build at a location level.',
        minValue: 8000,
        maxValue: 15500,
      ...
      },
      {
        ...
        description:
          'Synthetic turn-time curve shows the earliest member-facing symptom inferred from the harvest ramp and throughput pressure.',
        minValue: 35,
        maxValue: 125,
      ...
      },
      {
        ...
        description:
          'Synthetic storage-utilization curve shows how the USDA harvest ramp could translate into a visible watch period before a hard constraint.',
        minValue: 40,
        maxValue: 100,
...
export function buildStoryDatasets(records: ChartRecord[], thresholdAnnotations: ThresholdAnnotationManifest) {
  return (Object.keys(thresholdAnnotations.stories) as StoryId[]).reduce<Record<StoryId, StoryDataset>>(
    (accumulator, storyId) => {
      ...
      accumulator[storyId] = {
        ...
        sourceTypes: [...new Set(storyRecords.map((record) => record.sourceType))],
      };
...
export function parseChartCsv(csv: string): ChartRecord[] {
